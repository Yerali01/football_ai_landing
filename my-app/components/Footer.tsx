      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div>
             ...
             <div className="space-y-4">
                <a 
                  href={`mailto:eraliflash@gmail.com`} 
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-accent text-accent-foreground font-semibold text-sm hover:opacity-90 transition-all shadow-lg shadow-accent/20 group w-full sm:w-auto justify-center md:justify-start"
                >
        ...
        <div className="pt-8 border-t border-white/5 text-center">
           <p className="text-sm text-muted-foreground">
             &copy; {new Date().getFullYear()} Football AI. All rights reserved.
           </p>
        </div>
      </div>
    </footer>
